 ...
 */
final class Version20240423090723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_6A2CA10CFD02F13 ON media (evenement_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6A2CA10CFD02F13 ON media');
    }
}
